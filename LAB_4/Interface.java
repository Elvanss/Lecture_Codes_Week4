...
public class Interface {
    ...
    public static void MainMenuLogin(InsuranceCompany insuranceCompany) throws CloneNotSupportedException {
        mainMenu();
    ...
    public static void adminMenuOption(InsuranceCompany insuranceCompany) throws CloneNotSupportedException {
        adminMenu();
        Scanner info = new Scanner(System.in);
    ...
    public static void userMenu() {
        ...
        System.out.println("(3): Print Total Payment after rising");
        System.out.println("(4): Create Third Party Policy");
